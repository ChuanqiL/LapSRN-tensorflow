...
def distorted_images(images=None, height=24, width=24):
    ...
    """
    print(
        "This function is deprecated, please use tf.map_fn instead, e.g:\n   \
    ...
    result = tf.while_loop(
        cond=c, body=body, loop_vars=(distorted_x, i), parallel_iterations=16)
    return result
...
def crop_central_whiten_images(images=None, height=24, width=24):
    ...
    def body(central_x, i):
        ...
        image = tf.image.resize_image_with_crop_or_pad(
            tf.gather(images, i), height, width)
    ...
    result = tf.while_loop(
        cond=c, body=body, loop_vars=(central_x, i), parallel_iterations=16)
    return result
